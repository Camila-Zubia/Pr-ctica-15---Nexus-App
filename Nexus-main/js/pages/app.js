...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const initFeed = () => {
    ...
    document
      ...
      .addEventListener("click", showPostModal);
  ...
  const loadPosts = async () => {
    ...
    try {
      ...
      postsContainer.innerHTML = posts.length
        ? ""
        : '<p style="text-align:center; color: var(--text-sub);">No hay posts aún.</p>';
        ...
        postEl.innerHTML = `
                ...
                <div class="comments-section" id="comments-${post.id}">
                    ...
                    <form class="comment-form" data-post-id="${post.id}">
                        <img class="avatar" style="width: 32px; heigth: 32px;" src="https://ui-avatars.com/api/?name=${user?.name || "U"}&background=4F46E5&color=fff" alt="Avatar">
